...
const SensorPage = () => {
  useEffect(() => {
    ...
    orientationSensor.addEventListener('reading', () => {
        ...
        // Assuming this also handles the inclinometer data
  ...
  return (
    <Grid container spacing={2} style={{ padding: 20 }}>
      <Grid item xs={12} md={6} lg={4}>
        <Card>
          <CardContent>
            <Typography variant="h5" component="h2">Accelerometer</Typography>
            <Typography component="p" id="accelerometer">Waiting for data...</Typography>
          </CardContent>
        </Card>
      </Grid>
      ...
      <Grid item xs={12} md={6} lg={4}>
        <Card>
          <CardContent>
            <Typography variant="h5" component="h2">Accelerometer (Gravity)</Typography>
            <Typography component="p" id="gravity">Waiting for data...</Typography>
          </CardContent>
        </Card>
      </Grid>
      ...
      <Grid item xs={12} md={6} lg={4}>
        <Card>
          <CardContent>
            <Typography variant="h5" component="h2">Gyroscope</Typography>
            <Typography component="p" id="gyroscope">Waiting for data...</Typography>
          </CardContent>
        </Card>
      </Grid>
      ...
      <Grid item xs={12} md={6} lg={4}>
        <Card>
          <CardContent>
            <Typography variant="h5" component="h2">Orientation</Typography>
            <Typography component="p" id="orientation">Waiting for data...</Typography>
          </CardContent>
        </Card>
      </Grid>
      ...
      <Grid item xs={12} md={6} lg={4}>
        <Card>
          <CardContent>
            <Typography variant="h5" component="h2">Inclinometer</Typography>
            <Typography component="p" id="inclinometer">Waiting for data...</Typography>
          </CardContent>
        </Card>
      </Grid>
    </Grid>
